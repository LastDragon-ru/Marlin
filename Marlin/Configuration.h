...
#define DELTA
  ...
  #define DELTA_RADIUS 157.24             // (mm) Get this value from G33 auto calibrate

  // Trim adjustments for individual towers
  // tower angle corrections for X and Y tower / rotate XYZ so Z tower angle = 0
  // measured in degrees anticlockwise looking from above the printer
  #define DELTA_TOWER_ANGLE_TRIM { +0.02, -0.11, +0.09 } // Get these values from G33 auto calibrate
...
// Homing speeds (mm/m)
//#define HOMING_FEEDRATE_XY (50*60)  // Delta only homes to Z
